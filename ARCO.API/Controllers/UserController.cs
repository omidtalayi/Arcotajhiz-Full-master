...
using ARCO.Api.Presentation.Models.Request.v1;
using ARCO.Api.Presentation.Models.Response;
...
namespace ARCO.API.Controllers
{
    ...
    public class UserController : BaseApiPresentationController
    {
        //GET: User
        [Route("authenticate")]
        [HttpPost]
        public IHttpActionResult Authenticate([FromBody] AuthenticationInputReqeust input)
        {
            ...
            try
            {
                ...
                {
                    //DateTime databaseCurrentServerDate = Engine.Instance.ApplicationBusiness.GetDatabaseServerTime();
                    DateTime databaseCurrentServerDate = DateTime.Now;
                    string token = "";
                    string tokenCode = "";
        ...
        //        response.Errors.Add(ApiErrorCodeEnum.SERVER_ERROR.ToString());
        //        response.State = ResponseStateEnum.FAILED;
        //        //ARCO.Common.Business.Engine.Instance.ErrorBusiness.ErrorLogIns(ex, ModuleName: "User/authenticateHash");
        //        objResponse = Request.CreateResponse(HttpStatusCode.InternalServerError, response);
        //    }
        //    return ResponseMessage(objResponse);
        //}
