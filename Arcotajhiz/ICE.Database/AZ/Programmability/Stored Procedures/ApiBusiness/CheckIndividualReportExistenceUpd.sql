CREATE PROCEDURE [AZ].[CheckIndividualReportExistenceUpd](
	@UserVCode								BIGINT,
	@CheckIndividualReportExistenceVCode	BIGINT,
...
BEGIN
	BEGIN TRY
		...
		UPDATE AZ.CheckIndividualReportExistenceReportSource
		...
		WHERE	CheckIndividualReportExistenceVCode = @CheckIndividualReportExistenceVCode AND
